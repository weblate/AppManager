...
public class ReflectUtils {
    ...
    public static PackageOps opsConvert(Object object) {
        ...
        Object mPackageName = invokMethod(object, "getPackageName",null,null);
        if (mPackageName instanceof String) {
            packageName = ((String) mPackageName);
        }

        Object mUid = invokMethod(object, "getUid",null,null);
        if (mUid instanceof Integer) {
            uid = ((Integer) mUid);
        }

        Object mEntries = invokMethod(object, "getOps",null,null);
        if (mEntries instanceof List) {
            @SuppressWarnings("rawtypes")
            List list = (List) mEntries;
            entries = new ArrayList<>();
            for (Object o : list) {
                int mOp = (int) invokMethod(o, "getOp",null,null);
                int mMode = (int) invokMethod(o, "getMode",null,null);
                long mTime = (long) invokMethod(o, "getTime",null,null);
                long mRejectTime = (long) invokMethod(o, "getRejectTime",null,null);
                long mDuration = (long) invokMethod(o, "getDuration",null,null);
