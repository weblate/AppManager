...
public interface IAppOpsService {
    ...
    List<Parcelable> getPackagesForOps(int[] ops);  // AppOpsManager.PackageOps
...
//    void getHistoricalOpsFromDiskRaw(int uid, String packageName, List<String> ops,
...
//    void clearHistory();
    List<Parcelable> getUidOps(int uid, int[] ops);  // AppOpsManager.PackageOps
    ...
    void setUserRestriction(int code, boolean restricted, IBinder token, int userHandle, String[] exceptionPackages);
